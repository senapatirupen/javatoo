...
public class InfiniteStreamsTakeWhileDropWhile {
    ...
    public static void main(String[] args) {
        ...
        Supplier<String> passwordSupplier = InfiniteStreamsTakeWhileDropWhile::randomPassword;
        ...
        List<String> result9 = Stream.generate(InfiniteStreamsTakeWhileDropWhile::randomPassword)
        ...
        List<String> result13 = Stream.generate(InfiniteStreamsTakeWhileDropWhile::randomPassword)
