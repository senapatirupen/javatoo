package com.example.javatoo.designpattern.loandesignpattern;
...
public class Formula {
    ...
    private Formula() throws IOException {
        result = 0.0d;
        scanner = new Scanner(Path.of("src\\main\\java\\com\\example\\javatoo\\designpattern\\loandesignpattern\\doubles.txt"), StandardCharsets.UTF_8);
    }
